...
class CompetitionsControllerTest < ActionController::TestCase
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post :create, competition: { end: @competition.end, start: @competition.start, title: @competition.title, type: @competition.type }
    end
  ...
  test "should update competition" do
    patch :update, id: @competition, competition: { end: @competition.end, start: @competition.start, title: @competition.title, type: @competition.type }
    assert_redirected_to competition_path(assigns(:competition))
  end
